  ...
  return (
    <>
      <div className="absolute top-0 left-0 w-full h-full -z-10 ">
        <Aurora
          colorStops={["#3e076e", "#2d8db3", "#2c32a8"]}
          blend={0.5}
          amplitude={1.0}
          speed={0.5}
        />
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-8 grid-cols-1">
          <div className="animate__animated animate__fadeInUp animate__delay-3s flex flex-col items-center text-center md:items-start md:text-left">
            ...
            <BlurText
              text="Saya seorang pengembang web dan front-end mobile yang penuh semangat, berdedikasi menciptakan aplikasi modern yang inovatif, berkinerja tinggi, dan ramah pengguna."
              delay={150}
              animateBy="words"
              direction="top"
          ...
          <div className="w-full flex justify-center md:justify-end animate__animated animate__fadeInUp animate__delay-4s">
            <ProfileCard
              ...
              avatarUrl="./assets/argaa.png"
              showUserInfo={true}
              enableTilt={true}
              enableMobileTilt={false}
              onContactClick={() => window.open('https://wa.me/6281259149823', '_blank')}
            />
          </div>
        </div>
        {/* tentang */}
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 pt-0 px-8" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
            <div className="basis-full md:basis-7/12 pr-0 md:pr-8 border-b md:border-b-0 md:border-r border-violet-500/30">
              ...
              <div className="flex-1 text-left">
                ...
                <p className="text-base md:text-lg leading-relaxed mb-10 text-gray-300 text-justify">
                  Saya Argani Fernanda Widianto, seorang web dan front-end mobile developer yang penuh semangat dalam membangun aplikasi modern dan berkinerja tinggi dengan pengalaman pengguna yang intuitif. Saya senang bekerja dengan teknologi terbaru seperti Kecerdasan Buatan (AI) dan Machine Learning, serta memadukan kreativitas dengan ketepatan untuk menghadirkan solusi yang berdampak luas. Dengan pengalaman lebih dari tiga tahun dan lebih dari 10 proyek yang telah diselesaikan, saya berkomitmen untuk membantu pengguna dan bisnis berkembang di era digital melalui produk digital yang fungsional, estetis, dan dapat diskalakan.
                </p>
                ...
                <div className="flex flex-col sm:flex-row items-center sm:justify-between text-center sm:text-left gap-y-8 sm:gap-y-0 mb-4 w-full">
                  ...
                  <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600" data-aos-once="true">
                    <h1 className="text-3xl md:text-4xl mb-1">
                      3.86<span className="text-violet-500">/4.00</span>
                    </h1>
                    <p>GPA</p>
                  </div>
                </div>
            ...
            {/* Kolom kanan */}
            <div className="basis-full md:basis-5/12 pl-0 md:pl-8 overflow-hidden max-w-full flex justify-center w-full max-h-[400px] md:max-h-full">
        ...
        <div className="tools mt-32">
          ...
          <p className="w-full sm:w-3/5 md:w-2/5 text-sm sm:text-base/loose opacity-50" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300" data-aos-once="true">My Profesional Skills</p>
        ...
        <div className="kontak mt-32 sm:p-10 p-0" id="contact">
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1">
              <form
                action="https://formsubmit.co/arganifernanda68@gmail.com"
                method="POST"
