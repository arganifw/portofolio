  ...
  return (
    <div className="mt-32 pb-8 flex flex-col items-center relative z-10">
      ...
      <div className="w-full flex flex-col md:flex-row items-center md:justify-between gap-6">
        ...
        <h1 className="text-xl sm:text-2xl font-bold order-1 md:order-none">
          Portofolio
        </h1>

        {/* Ikon Sosmed - di tengah di mobile */}
        <div className="flex gap-3 order-2 md:order-none md:absolute md:left-1/2 md:-translate-x-1/2">
          <a href="https://github.com/arganifw"><i className="ri-github-fill ri-2x"></i></a>
          <a href="https://www.instagram.com/argani.fw/"><i className="ri-instagram-fill ri-2x"></i></a>
        </div>
